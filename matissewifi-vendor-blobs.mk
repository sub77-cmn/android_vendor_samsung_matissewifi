...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/lib/lib_asb_tee.so:system/lib/lib_asb_tee.so \
    $(LOCAL_PATH)/proprietary/lib/libkeyctrl.so:system/lib/libkeyctrl.so \
    $(LOCAL_PATH)/proprietary/lib/libscdclient.so:system/lib/libscdclient.so \
    $(LOCAL_PATH)/proprietary/vendor/lib/libwvdrmengine.so:system/vendor/lib/libwvdrmengine.so
